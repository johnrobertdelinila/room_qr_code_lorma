...
import com.example.johnrobertdelinila.roomqrcode.barcodedetection.BarcodeProcessor;
import com.example.johnrobertdelinila.roomqrcode.barcodedetection.BarcodeResultFragment;
...
import com.example.johnrobertdelinila.roomqrcode.settings.SettingsActivity;
import com.google.android.gms.common.internal.Objects;
import com.google.android.material.chip.Chip;
import com.example.johnrobertdelinila.roomqrcode.camera.GraphicOverlay;
import com.example.johnrobertdelinila.roomqrcode.camera.CameraSource;
import com.example.johnrobertdelinila.roomqrcode.camera.CameraSourcePreview;
...
public class LiveBarcodeScanningActivity extends AppCompatActivity implements OnClickListener {
  ...
  protected void onResume() {
    ...
    cameraSource.setFrameProcessor(new BarcodeProcessor(graphicOverlay, workflowModel, LiveBarcodeScanningActivity.this));
  ...
  private void setUpWorkflowModel() {
        ...
        workflowState -> {
          ...
          switch (workflowState) {
            case DETECTING:
              ...
              promptChip.setText(getString(R.string.prompt_point_at_a_barcode));
              startCameraPreview();
              break;
            case CONFIRMING:
              promptChip.setVisibility(View.VISIBLE);
    ...
    workflowModel.detectedBarcode.observe(
      this,
      barcode -> BarcodeResultFragment.show(getSupportFragmentManager(), workflowModel.documentSnapshot, workflowModel.error, barcode));
  }
}
